...
public class AdapterListViewVisitUser extends RecyclerView.Adapter<AdapterListViewVisitUser.MyViewHolder> {
    Context context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //AdapterListViewVisitUser.MyViewHolder holder = new AdapterListViewVisitUser.MyViewHolder(view);
        //return holder;
        return new MyViewHolder(view);
    }

    public AdapterListViewVisitUser(ListViewVisitUser listViewVisitUser, ArrayList<HashMap<String, String>> list_data) {
        this.context = listViewVisitUser;
