...
public class ListSalesVisit extends AppCompatActivity {
    // Deklarasi
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String getsalesid = intent.getStringExtra("intentsalesid");
        ...
        btnseeall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ListSalesVisit.this, ViewAllVisitByDate.class);
                ...
                ListSalesVisit.this.startActivity(i);
    ...
    /*
    private void loadlistvisitall (){
        //Intent intent = getIntent();
        //final String carinamafoto = intent.getStringExtra("datacariojek");

        String url = "http://www.biggestworks.com/Android/era/getlisttrackingbydate.php";
        //recyclerView = (RecyclerView) findViewById(R.id.RV_ListVisitSales);
        //recyclerView.setLayoutManager(new LinearLayoutManager(this));


        requestQueue = Volley.newRequestQueue(ListSalesVisit.this);
        ...
        stringRequest = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.isEmpty()) {
                    Toast.makeText(ListSalesVisit.this, "Data kunjungan user tidak ditemukan!", LENGTH_SHORT).show();
                } else {
                    try {
                        JSONObject jsonObject = new JSONObject(response);
                        JSONArray jsonArray = jsonObject.getJSONArray("listtrackingbydate");
                        ...
                        for (int a = 0; a < jsonArray.length(); a++) {
                            ...
                            list_data.add(map);
                            //AdapterListSalesVisit adapter = new AdapterListSalesVisit(ListSalesVisit.this, list_data);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListSalesVisit.this, error.getMessage(), LENGTH_SHORT).show();
            }
                ...
                if (response.isEmpty()) {
                    ...
                    try {
                        ...
                        for (int a = 0; a < jsonArray.length(); a++) {
                            JSONObject json = jsonArray.getJSONObject(a);
                            HashMap<String, String> map = new HashMap<String, String>();
                            map.put("visitid", json.getString("visit_id")); //tambahan
                            map.put("visitsalesid", json.getString("visit_sales_id"));
                            map.put("visitsalesdate", json.getString("visit_date"));
                            map.put("visitnotes", json.getString("visit_notes"));
                            map.put("visitvisitno", json.getString("visit_visitno"));
