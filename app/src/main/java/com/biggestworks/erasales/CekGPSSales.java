...
public class CekGPSSales extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    public String getintentvisitno, getintentsalesname;
    private static final String TAG = CekGPSSales.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getintentvisitno = intent.getStringExtra("intentvisitno");
        getintentsalesname = intent.getStringExtra("intentsalesname");
        SupportMapFragment fm = (SupportMapFragment)
                getSupportFragmentManager().findFragmentById(R.id.map);
        fm.getMapAsync(CekGPSSales.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            requestQueue = Volley.newRequestQueue(CekGPSSales.this);
            ...
            stringRequest = new StringRequest(Request.Method.POST, urltrack, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.isEmpty()) {
                        Toast.makeText(CekGPSSales.this, "Data tracking kunjungan sales tidak ditemukan!", LENGTH_SHORT).show();
                    } else {
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            JSONArray jsonArray = jsonObject.getJSONArray("tracking_sales");
                            ...
                            for (int a = 0; a < jsonArray.length(); a++) {
                                ...
                                options.title("time: " +jamdetik);

                                googleMap.addMarker(options);
                                CameraUpdate updatePosition = CameraUpdateFactory.newLatLngZoom(position,13);
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(CekGPSSales.this, error.getMessage(), LENGTH_SHORT).show();
                }
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("search", getintentvisitno);
