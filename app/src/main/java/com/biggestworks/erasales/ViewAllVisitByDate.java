...
public class ViewAllVisitByDate extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    private static final String TAG = ViewAllVisitByDate.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fm.getMapAsync(ViewAllVisitByDate.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            String urltrack = "http://www.biggestworks.com/Android/era/getlisttrackingbydate.php";
            requestQueue = Volley.newRequestQueue(ViewAllVisitByDate.this);
            ...
            stringRequest = new StringRequest(Request.Method.POST, urltrack, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.isEmpty()) {
                        Toast.makeText(ViewAllVisitByDate.this, "Data tracking kunjungan user tidak ditemukan!", LENGTH_SHORT).show();
                    } else {
                        try {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ViewAllVisitByDate.this, error.getMessage(), LENGTH_SHORT).show();
                }
    ...
    private void getdatasalestrackingbyvisit (){
        ...
        stringRequest = new StringRequest(Request.Method.POST, urltrack, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.d("response ", response);
                if (response.isEmpty()) {
                    Toast.makeText(ViewAllVisitByDate.this, "Data tracking kunjungan sales tidak ditemukan!", LENGTH_SHORT).show();
                } else {
                    try {
                        JSONObject jsonObject = new JSONObject(response);
